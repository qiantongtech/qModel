 ...
 * @date 2023-09-14
 */
public interface IModelInputReconstitutionService {
    /**
     * 查询模型输入管理
     *
     * @param id 模型输入管理 主键
    ...
    /**
     * 输入文件的闸门控制(shuniu_zhamenkongzhi.dat)文件读取
     * @param filePath
     * @return
     */
    JSONArray shuniuZhamenkongzhi(String filePath);

    /**
     * 输入文件的闸门控制(hedaosunshi.dat)文件读取
     * @param filePath
     * @return
     */
    JSONArray hedaosunshi(String filePath);
