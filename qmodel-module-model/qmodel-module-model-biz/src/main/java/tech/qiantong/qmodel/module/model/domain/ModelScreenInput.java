...
public class ModelScreenInput {
    ...
    // 第一枢纽闸门控制
    private String diyishuniu;

    // 第二枢纽闸门控制
    private String diershuniu;

    // 第三枢纽闸门控制
    private String disanshuniu;
    ...
    public String getDiyishuniu() {
        return diyishuniu;
    }

    public void setDiyishuniu(String diyishuniu) {
        this.diyishuniu = diyishuniu;
    }

    public String getDiershuniu() {
        return diershuniu;
    }

    public void setDiershuniu(String diershuniu) {
        this.diershuniu = diershuniu;
    }

    public String getDisanshuniu() {
        return disanshuniu;
    }

    public void setDisanshuniu(String disanshuniu) {
        this.disanshuniu = disanshuniu;
    }

    public String getThirdShunshi() {
        return thirdShunshi;
    }

    public void setThirdShunshi(String thirdShunshi) {
        this.thirdShunshi = thirdShunshi;
    }
    ...
    public ModelScreenInput(String firstSuppliesWater, String secondSuppliesWater, String hsgTable, String wlstRiverWater, String firstSouthHub, String firstNorthHub, String firstShunshi, String secondSouthHub, String secondNorthHub, String secondShunshi, String dongZhiShunshi, String xiZhiShunshi, String xskTable, String beginDate, String endDate) {
        this.firstSuppliesWater = firstSuppliesWater;
        this.secondSuppliesWater = secondSuppliesWater;
        this.hsgTable = hsgTable;
        this.wlstRiverWater = wlstRiverWater;
