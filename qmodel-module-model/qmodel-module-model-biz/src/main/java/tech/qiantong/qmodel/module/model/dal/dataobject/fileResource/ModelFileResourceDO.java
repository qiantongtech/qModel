...
package tech.qiantong.qmodel.module.model.dal.dataobject.fileResource;
...
/**
 * 模型文件部署 DO 对象 model_file_resource
 *
 * @author anivia
 * @date 2026-07-07
 */
@Data
@TableName(value = "model_file_resource")
// 用于 Oracle、PostgreSQL、Kingbase、DB2、H2 数据库的主键自增。如果是 MySQL 等数据库，可不写。
// @KeySequence("model_file_resource_seq")
@Builder
@NoArgsConstructor
@AllArgsConstructor
@EqualsAndHashCode(callSuper = true)
public class ModelFileResourceDO extends BaseEntity {
