                                    ...
                                    <div class="card-item" @click="handleView(item)">
                                        ...
                                        <div class="item-btns">
                                            <template v-if="['0','2'].includes(String(item.status))">
                                              ...
                                              >
                                                <template #reference>
                                                  <el-button type="primary" icon="More" link @click.stop
                                                  >更多</el-button>
                                                </template>
...
<script setup>
    ...
    const { model_access_type,model_status } = proxy.useDict('model_access_type','model_status');
