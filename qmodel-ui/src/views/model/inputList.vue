    ...
    <div class="app-container modelInput">
                ...
                >
                    <template #default="scope">
                        ...
                        <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)"
                                   v-hasPermi="['model:input:edit']">修改
                        </el-button>
                        <el-button link type="danger" icon="Delete" @click="handleDelete(scope.row)"
                                   v-hasPermi="['model:input:remove']">删除
                        </el-button>
                        <el-button link type="primary" @click="handleView(scope.row)" icon="view" v-hasPermi="['model:input:edit']">
                            详情
                        </el-button>
                    </template>
                </el-table-column>
        ...
        <el-dialog :title="title" v-model="open" width="800px" :append-to="$refs['app-container']" draggable>
            ...
            >
                ...
                <el-form-item label="参数名称：" prop="name" v-if="form.modelVersion != null && form.modelId != null">
                    <el-input
                        clearable
                        v-model="form.name"
                        placeholder="请输入参数名称"
                ...
                <el-form-item :label="form.modelId.format == 0 ? '文件名称：' : '字段名称：'" prop="engName" v-if="form.modelVersion != null && form.modelId != null">
                    <el-input
                        clearable
                        v-model="form.engName"
                        :placeholder="form.modelId.format == 0 ? '请输入文件名称' : '请输入字段名称'"
                    />
                </el-form-item>

                <el-form-item label="是否可变：" prop="changeFlag" v-if="form.modelVersion != null && form.modelId != null">
                    <el-radio v-model="form.changeFlag" label="true">是</el-radio>
                    <el-radio v-model="form.changeFlag" label="false">否</el-radio>
                </el-form-item>
                <el-form-item label="参数类型：" prop="type" v-if="form.modelVersion != null && form.modelId != null">
                    <el-select
                        v-model="form.type"
                        placeholder="请选择参数类型"
                        clearable
                ...
                <el-form-item label="单值默认值：" prop="singleContent" v-if="form.type === 0">
                    <el-input
                        clearable
                ...
                <el-form-item label="多列数示例：" prop="multipleContent" v-if="form.type === 1">
        ...
        >
            ...
            <el-form ref="form" :model="formView" label-width="110px">
                <el-row :gutter="20">
                    <el-col :span="12">
                ...
                <el-row :gutter="20">
                    ...
                    <el-col :span="12">
                        <el-form-item :label="formView.type == 0 ? '文件名称' : '字段名称'" prop="engName">
                ...
                <el-row :gutter="20">
                    <el-col :span="12">
                        <el-form-item label="参数类型" prop="type">
                            <dict-tag :options="model_input_param_type" :value="formView.type" />
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="是否可变" prop="changeFlag">
                            <dict-tag :options="model_change_flag" :value="formView.changeFlag" />
                        </el-form-item>
                    </el-col>
                </el-row>
...
export default {
    ...
    data() {
        return {
            ...
            model_change_flag: useDict("model_change_flag").model_change_flag,
    ...
    methods: {
        ...
        handleView(row) {
            ...
            getInput(id).then((response) => {
                ...
                if (this.formView.singleContent) {
                    try {
                ...
                if (this.formView.multipleContent) {
                    try {
