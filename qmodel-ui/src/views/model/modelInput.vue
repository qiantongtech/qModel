    ...
    <div class="app-container">
        ...
        >
            ...
            >
                ...
                "
                                    value-key="id"
                            >
                                <el-option v-for="dict in modelList" :key="dict.id" :label="dict.name" :value="dict"/>
                            </el-select>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
                    <el-col :span="20">
                        <el-form-item label="所属版本：" prop="modelVersion">
                            <el-select v-model="form.modelVersion" placeholder="请先选择所属模型" clearable
                                       style="width: 100%">
                                <el-option v-for="dict in versionList" :key="dict.id" :label="dict.version"
        ...
        >
            ...
            >
                ...
                <el-row>
                    <el-col :span="20">
                        <el-form-item :label="formView.type == 1 ? '文件名称：' : '字段名称：' " prop="engName">
                            {{ formView.engName }}
                        </el-form-item>
                    </el-col>
                </el-row>
