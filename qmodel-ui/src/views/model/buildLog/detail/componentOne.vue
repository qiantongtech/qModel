...
<template>
  <div class="justify-between mb15">
    <el-row :gutter="15" class="btn-style">
      <el-col :span="1.5">
        <el-button type="primary" plain @click="handleAdd" v-hasPermi="['buildLog:modelBuildLog:add']"
                   @mousedown="(e) => e.preventDefault()">
          <i class="iconfont-mini icon-xinzeng mr5"></i>新增
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="warning" plain :disabled="multiple" @click="handleExport" v-hasPermi="['buildLog:modelBuildLog:export']"
                   @mousedown="(e) => e.preventDefault()">
  ...
  <el-table stripe height="374px" v-loading="loading" :data="modelBuildLogList" @selection-change="handleSelectionChange" :default-sort="defaultSort" @sort-change="handleSortChange">
    <el-table-column type="selection" width="55" align="center" />
            <el-table-column v-if="columns[0].visible" label="ID" align="center" prop="id" />
            <el-table-column v-if="columns[1].visible" label="模型文件id" align="center" prop="resourceId">
            ...
            <el-table-column v-if="columns[7].visible" label="开始时间" align="center" prop="startTime" width="180">
              <template #default="scope">
                <span>{{ parseTime(scope.row.startTime, '{y}-{m}-{d}') }}</span>
              </template>
            </el-table-column>
            <el-table-column v-if="columns[8].visible" label="结束时间" align="center" prop="endTime" width="180">
              <template #default="scope">
            ...
            <el-table-column v-if="columns[10].visible" label="已存在的依赖包列表JSON" align="center" prop="installedPackages">
              <template #default="scope">
                {{ scope.row.installedPackages || '-' }}
              </template>
            </el-table-column>
            <el-table-column v-if="columns[11].visible" label="缺失失败的依赖包列表JSON" align="center" prop="missingPackages">
              <template #default="scope">
            ...
            <el-table-column v-if="columns[15].visible" label="错误日志" align="center" prop="errorMessage">
              <template #default="scope">
                {{ scope.row.errorMessage || '-' }}
              </template>
            </el-table-column>
            <el-table-column v-if="columns[16].visible" label="requirements.txt 内容" align="center" prop="requirements">
              <template #default="scope">
            ...
            <el-table-column v-if="columns[21].visible" label="创建时间" align="center" prop="createTime" width="180" sortable="custom" :sort-orders="['descending', 'ascending']">
              <template #default="scope">
    ...
    <el-table-column label="操作" align="center" class-name="small-padding fixed-width" fixed="right" width="240">
      <template #default="scope">
        <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)"
                   v-hasPermi="['buildLog:modelBuildLog:edit']">修改</el-button>
        <el-button link type="danger" icon="Delete" @click="handleDelete(scope.row)"
                   v-hasPermi="['buildLog:modelBuildLog:remove']">删除</el-button>
        <el-button link type="primary" icon="view" @click="handleDetail(scope.row)"
                   v-hasPermi="['buildLog:modelBuildLog:edit']">详情</el-button>
      </template>
    </el-table-column>
