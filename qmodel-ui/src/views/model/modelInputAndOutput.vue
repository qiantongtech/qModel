    ...
    <div class="app-container">
        ...
        <el-button type="primary" size="small">返回</el-button>
            ...
            <el-descriptions-item>
                <template slot="label"> 模型名称 </template>
                {{ model.name }}
            </el-descriptions-item>
            <el-descriptions-item>
            ...
            <el-descriptions-item>
                <template slot="label"> 模型版本 </template>
            ...
            <el-descriptions-item>
                <template slot="label"> 接口说明 </template>
...
<script setup>
    ...
    const saveData = () => {
        ...
        form.value.inputParameterIllustrate = JSON.stringify(Object.fromEntries(inputMap));
        form.value.outputParameterIllustrate = JSON.stringify(Object.fromEntries(outputMap));
        if (form.value.inputParameter === '{}' || form.value.inputParameter === '[]') {
            form.value.inputParameter = null;
        }
        if (form.value.outputParameter === '{}' || form.value.outputParameter === '[]') {
