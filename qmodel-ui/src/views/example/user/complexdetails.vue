    ...
    <div  class="pagecont-bottom">
        <el-tabs v-model="activeName" class="demo-tabs" @tab-click="handleClick">
            <el-tab-pane label="家长管理" name="1">
                ...
                <el-table stripe height="374px" v-loading="loading" :data="userTypeList" @selection-change="handleSelectionChange" :default-sort="{ prop: 'createTime', order: 'descending' }">
                    ...
                    <el-table-column label="操作" align="center" class-name="small-padding fixed-width" fixed="right" width="240">
                        ...
                        <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)"
                                    v-hasPermi="['user:userType:edit']">修改</el-button>
                        <el-button link type="danger" icon="Delete" @click="handleDelete(scope.row)"
                                    v-hasPermi="['user:userType:remove']">删除</el-button>
                        </template>
                    </el-table-column>
