    ...
    <div class="pagecont-top" v-show="showSearch">
        <el-form class="btn-style" :model="queryParams" ref="queryRef" :inline="true" label-width="75px">
          ...
          <el-form-item label="部门状态" prop="status">
            <el-select  v-model="queryParams.status" placeholder="请选择部门状态" clearable class="el-form-input-width">
              <el-option
      ...
      <right-toolbar v-model:showSearch="showSearch" @queryTable="getList"></right-toolbar>
        ...
        <el-table-column label="邮箱" align="center" prop="email" >
          ...
          <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
            <template #default="scope">
              <el-button link type="primary" @click="handleUpdate(scope.row)" v-hasPermi="['gen:dept:edit']">
...
import { listDept, getDept, delDept, addDept, updateDept } from "@/api/example/gen/dept";
...
function handleDelete(row) {
  proxy.$modal.confirm('是否确认删除示例部门编号为"' + row.id + '"的数据项？').then(function() {
