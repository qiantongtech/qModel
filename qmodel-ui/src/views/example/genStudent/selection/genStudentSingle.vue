...
<template>
  ...
  >
    ...
    >
      ...
      <el-table-column label="学生照" align="center" prop="pictureUrl">
        <template #default="scope">
...
<script setup name="GenStudentSingle">
  import { listGenStudent } from "@/api/example/genStudent/genStudent";
  import { ref } from "vue";
  ...
  function getList() {
    loading.value = true;
    listGenStudent(proxy.addDateRange(queryParams.value, daterangeCreateTime.value)).then(
        async (response) => {
