...
INSERT INTO `system_menu` VALUES (2319, '模型计算', 2310, 4, 'calc', 'model/calc/index', NULL, 1, 0, NULL, 'C', '0', '0', 'model:calc:calc:list', '#', 'admin', '2026-07-27 14:31:18', '', NULL, '模型计算任务菜单');
